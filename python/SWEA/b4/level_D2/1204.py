...
#         score_list[j] += 1
#
#         for score_index, score_max in enumerate(score_list):
#             if max_score_cnt <= score_max:
#                 max_score_cnt = score_max
#                 max_score = score_index
#
#             # while max_score_cnt <= score_max:
#             #     max_score_cnt = score_max
#             #     max_score = score_index
#             #     break
#
#     print(f'#{no_test_case} {max_score}')
